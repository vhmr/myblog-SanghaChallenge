...
function Post({ post }: Props) {
  ...
  const [sudmited, setSubmited] = useState(false);  
  const { register, handleSubmit, formState:{ errors} } = useForm<IformInputs>(); 

  const onSumit: SubmitHandler<IformInputs> = async (data) => {
  ...
  return (
      <main>
          ...
          <article className="max-w-3xl mx-auto p-5">
              ...
              <div className="mt-10">
                  <PortableText 
                    ...
                    serializers={{
                       h1: (props: any) => (
                           <h1 className="text-2xl font-bold my-5" {...post} />
                       ),
                       h2: (props: any) => (
                           <h1 className="text-xl font-bold my-5" {...post} />
                       ),
                       li: ({ children }: any) => (
        ...
        {sudmited ? (
          ...
          <form onSubmit={handleSubmit(onSumit)} className="flex flex-col p-5 max-w-2xl mx-auto mb-10">

            <h3 className="text-sm text-yellow-500">Employed this article?</h3>
            ...
            {/* ERRORES DE LO CAMPOS Y VALIDACIONES*/}
